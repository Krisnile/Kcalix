...
const makeStyles = (colors: Palette) =>
  ...
  amountInput: { width: 68, height: 32, paddingHorizontal: 4, paddingVertical: 0, fontSize: font.xl, lineHeight: 28, fontWeight: '800', color: colors.text, textAlign: 'right', textAlignVertical: 'center', outlineStyle: 'none' } as any,
  amountUnit: { fontSize: font.md, lineHeight: 22, color: colors.textSecondary, fontWeight: '600' },
